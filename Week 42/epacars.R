...
df_epacars <- as_tibble(data.table::fread(here::here("Week 42", "epacars.csv")))
...
ridge_anno_lbl <- latex2exp::TeX(paste0("\\textbf{$\\overset{Most\\,Common\\,CO_2}{level\\,in\\,the\\,group}}"))
