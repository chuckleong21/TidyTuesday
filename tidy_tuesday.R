...
#' excessively long url slug passed to \code{read_csv()}. It opens a browser
...
#' for year 2018, as for previous weeks are all on Mondays.
#' 
#' 
#' @param filename Single character for csv file
#' @param year integer 2018 or 2019
#' @param week integer Between 1 and 52
